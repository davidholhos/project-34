...
var box10,box12,box13,box14,box15,box16,box17,box18,box19,box20,box21,box22,box23,box24;
...
function setup() {
  ...
  box4 = new Box(950, 100, 50, 50);
  box5 = new Box(950, 100, 50, 50);
  ...
  box17 = new Box(950, 100, 50, 50);
  box18 = new Box(900, 100, 50, 50);
  box19 = new Box(800, 100, 50, 50);
  box20 = new Box(850, 100, 50, 50);
  box21 = new Box(825,20,50,50);
  box22 = new Box(875,20,50,50);
  box23 = new Box(925,20,50,50);
  box24 = new Box(850,10,50,50);
  box25 = new Box(900,10,50,50);
  //box26 = new Box(875,10,50,50);
